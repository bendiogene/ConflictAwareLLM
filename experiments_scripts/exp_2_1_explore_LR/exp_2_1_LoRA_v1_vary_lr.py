...
'''
EXPERIMENT 2.1 SCRIPT (Incremental learning) with LoRA:
Starting clean with LRs and letting the configuration files decide
...
def main():
        ...
        filename = os.path.join(config['EXPERIMENT_CONFIG']['results_dir'],
                                f"experiment_2_1_oldlr_{config['FT_CONFIG']['training_lr_1']}_newlr_{config['FT_CONFIG']['training_lr_2']}_{timestamp}.json")
